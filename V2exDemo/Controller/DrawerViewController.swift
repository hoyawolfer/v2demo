...
//  V2exDemo
//
//  Created by zaixuan on 2017/10/20.
    ...
    override func viewDidLoad() {
        ...
        panGesture.rx.event.subscribe(onNext:{[weak self] sender in
            ...
            case .changed:
                ...
                centerFrame.origin.x = min(self.leftDrawerWidth, max(self.startingPanX + point.x, 0))
...
extension UIViewController {
    var drawerViewController:DrawerViewController? {
        ...
        if let controller = presentedViewController as? DrawerViewController {
            return controller
        }
